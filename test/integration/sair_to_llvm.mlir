// RUN: sair-opt -sair-default-lowering-attributes -convert-sair-to-llvm -reconcile-unrealized-casts %s | mlir-runner -e from_scalar | FileCheck %s
// RUN: sair-opt -sair-default-lowering-attributes -convert-sair-to-llvm -reconcile-unrealized-casts %s | mlir-runner -e from_to_memref | FileCheck %s
