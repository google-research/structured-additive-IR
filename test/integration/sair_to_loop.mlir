// RUN: sair-opt -sair-default-lowering-attributes -convert-sair-to-loop -cse \
...
func @copy_to_memref(%arg0: memref<8xf32>, %arg1: memref<8xf32>) {
  ...
  sair.program {
    ...
    // CHECK:   %[[V1:.*]] = affine.apply affine_map<(d0)[s0] -> (d0 - s0)>(%[[V0]])[%[[C0]]]
    ...
    // CHECK:   memref.store %[[V2]], %[[ARG1]][%[[V1]]] : memref<8xf32>
